import { StyleSheet, Text, View, Image, StatusBar, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
                        ...
                        <View className='flex items-center mx-4 space-y-4'>
                            ...
                            <Animated.View entering={FadeInDown.delay(800).duration(1000).springify()} className='flex-row justify-center'>
                                ...
                                <TouchableOpacity onPress={() => navigation.push("Login")}>
                                    <Text className='text-sky-600 pl-1'>Login</Text>
                                </TouchableOpacity>
                            </Animated.View>
                        </View>
                    </View>
